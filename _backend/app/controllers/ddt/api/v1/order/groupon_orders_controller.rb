module Ddt
  module Api
    module V1
      module Backend
        class GrouponOrdersController < Ddt::Api::V1::BaseController
          ...
          def index
            orders = @branch.groupon_orders.includes(:pay_items, :line_items, :adjustments)
          ...
          def set_order
            @order = @branch.groupon_orders.find(params[:id])
          end
        end
      end
    end
