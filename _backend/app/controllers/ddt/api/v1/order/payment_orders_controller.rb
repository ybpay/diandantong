module Ddt
  module Api
    module V1
      module Backend
        class PaymentOrdersController < Ddt::Api::V1::BaseController
          ...
          def index
            orders = @branch.payment_orders.includes(:pay_items, :adjustments)
          ...
          def set_order
            @order = @branch.payment_orders.find(params[:id])
          end
        end
      end
    end
