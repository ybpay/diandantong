module Ddt
  module Api
    module V1
      module Backend
        class EatInHallOrdersController < Ddt::Api::V1::BaseController
          ...
          def index
            orders = @branch.eat_in_hall_orders.includes(:pay_items, :line_items, :adjustments)
          ...
          def set_order
            @order = @branch.eat_in_hall_orders.find(params[:id])
          end
        end
      end
    end
