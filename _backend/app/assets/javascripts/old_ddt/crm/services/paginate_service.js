CrmModules.add_service('paginate')
angular.module('crm.services.paginate', []).
  factory('PaginateService', [function(){
    /* useage
     * var Order = PaginateService.init(OrderService.query, { branch_id: $scope.branch_id }, function(orders){ $scope.orders = orders })
     * Order.query()
