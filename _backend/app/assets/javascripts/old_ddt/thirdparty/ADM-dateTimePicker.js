...
(function(angular) {
    ...
    return angular.module('ADM-dateTimePicker', [])
        .constant('constants', {
            calendars: {
                gregorian: {
                    monthsNames: '一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月'.split('_'),
                    daysNames: '周日_周一_周二_周三_周四_周五_周六'.split('_')
                },
                jalali: {
