WebposModules.add_service('fast_food_cart')
angular.module('webpos.services.fast_food_cart', []).
  factory('FastfoodCartService', ['$resource','BaseSnapCartService','FastfoodOrderService',
    function($resource, BaseSnapCartService, FastfoodOrderService){
    var carts = {}
