var App = angular.module('webpos_queue', WebposModules.get([
...
App.run(['$rootScope', 'TemplateService', 'AccountService','Box','NotifyService','$location','$cacheFactory','PermissionService','RouteConfig','LocalStorageCache','$http','$interval','$route','$state','$timeout','AuthorizationService',"WirePrinterService", "PrintService", 'QueueFormService', 'ExtendedFormService',
  function($rootScope, TemplateService, AccountService, Box, NotifyService, $location, $cacheFactory, PermissionService, RouteConfig,LocalStorageCache,$http, $interval, $route, $state, $timeout, AuthorizationService, WirePrinterService, PrintService, QueueFormService, ExtendedFormService){
   ...
   $rootScope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams) {
    ...
    $rootScope.partial = function(partial_name){
      return "/webpos/templates_queue/" + partial_name + ".html";
    }
