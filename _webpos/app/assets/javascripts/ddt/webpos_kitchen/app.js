var App = angular.module('webpos_kitchen', WebposModules.get([
...
App.run(['$rootScope', 'TemplateService', 'AccountService','Box','NotifyService','$location','$cacheFactory','PermissionService','RouteConfig','LocalStorageCache','$http','$interval','$route','$state',
  function($rootScope, TemplateService, AccountService, Box, NotifyService, $location, $cacheFactory, PermissionService, RouteConfig,LocalStorageCache,$http, $interval, $route, $state){
   ...
   $rootScope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams) {
    ...
    $rootScope.partial = function(partial_name){
      return "/webpos/templates_kitchen/" + partial_name + ".html";
    }
