var App = angular.module('webpos_estimate', WebposModules.get([
...
App.run(['$rootScope','TemplateService', 'AccountService','Box','NotifyService','$location','$cacheFactory','PermissionService','RouteConfig','LocalStorageCache','$http','$interval','$route','$state','$timeout','AuthorizationService',
  function($rootScope,TemplateService, AccountService, Box, NotifyService, $location, $cacheFactory, PermissionService,RouteConfig, LocalStorageCache,$http, $interval, $route, $state, $timeout, AuthorizationService){
   ...
   $rootScope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams) {
    ...
    $rootScope.partial = function(partial_name){
      return "/webpos/templates_estimate/" + partial_name + ".html";
    }
