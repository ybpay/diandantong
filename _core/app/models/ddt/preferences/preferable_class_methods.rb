  ...
  module Preferences
    module PreferableClassMethods
      ...
      def preference(name, type, *args)
        ...
        @declared_preference_keys = [] if @declared_preference_keys.nil?
        @declared_preference_keys << name
        ...
        define_method preference_getters_method do
          preferences.keys.map {|key| self.class.preference_getter_method(key)}
        end
      end
      ...
      def preference_getters_method
        'all_preferred_getters'.to_sym
      end

      def all_preference_getters
        @declared_preference_keys.try(:map) {|key| preference_getter_method(key)}
      end
    end
  end
end
